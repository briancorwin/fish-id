...
class TestPostprocess:
    ...
    def test_overlapping_boxes_nms_keeps_highest_confidence(self):
    ...
    def test_coordinate_roundtrip_wide_image(self):
        ...
        det = main._postprocess(output, orig_shape, scale, pad_left, pad_top)[0]
        assert det["box"] == {"x1": 200, "y1": 100, "x2": 400, "y2": 200}

    def test_coordinate_roundtrip_tall_image(self):
    ...
    def test_unknown_class_id_raises(self):
        ...
        with pytest.raises(ValueError, match="class_id 99"):
            main._postprocess(output, _ORIG_SHAPE, 1.0, 0, 0)
